...
const messages = {
  en: {
    ...
    taglineEnglish1: "Match each icon to its English word. Topic: {{topic}}",
    taglineEnglish2: "Match each Hebrew word to its English word. Topic: {{topic}}",
  ...
  he: {
    ...
    taglineEnglish1: "התאימו כל סמל למילה באנגלית. נושא: {{topic}}",
    taglineEnglish2: "התאימו כל מילה בעברית למילה באנגלית. נושא: {{topic}}",
