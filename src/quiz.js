...
/**
 * @typedef {{ id: string; prompt: string; choices: string[]; correctIndex: number }} QuizQuestion
 * @typedef {{ key: string; prompt: string; answer: string; symbol?: string; hebrew?: string; english?: string }} QuizFact
 */
